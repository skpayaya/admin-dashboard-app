    ...
    return (
        <div className="mt-12">
            <div className="flex flex-wrap lg:flex-nowrap">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-cen">
                    <div className="flex justify-between items-center">
                        <div>
                            <p className="font-bold text-gray-400">Earnings</p>
                            <p className="text-2xl ">$89,939.06</p>
                        </div>
                    </div>
                    <div className="mt-6">
                        <Button
